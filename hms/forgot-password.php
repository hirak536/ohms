...
<html lang="en">
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> OHMS | Patient Password Recovery</h2></a>
				</div>
					...
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-actions">
								...
								 
							<button type="submit" class="pull-right" name="submit"
								style="     background-color: #001f41fc;
    border: none;
    color: white;
    padding: 7px 13px;
    text-align: center;
    ...
    border-radius: 10px;">
					...
					<div class="copyright">
						&copy; <span class="text-bold text-uppercase">  Online Hospital Management System - Developed by PATEL JAY | PATEL JESUS | PATEL KUSH</span>
					</div>
