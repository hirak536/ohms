...
<html lang="en">
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.php"><h2> OHMS | Doctor Password Recovery</h2></a>
				</div>
    ...
    border-radius: 10px;">
					...
					<div class="copyright">
					<span class="text-bold text-uppercase"> Online Hospital Management System - Developed by PATEL JAY | PATEL JESUS | PATEL KUSH</span>
					</div>
