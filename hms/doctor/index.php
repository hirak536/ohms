...
<body class="login">
				...
				<form class="form-login" method="post">
					<fieldset>
						...
						<div class="form-actions">
							...
							<button type="submit" class="pull-right" name="submit" style="     background-color: #001f41fc;
	border: none;
	color: white;
	padding: 7px 13px;
	text-align: center;
	...
	border-radius: 10px;">
				...
				<div class="copyright">
					<span class="text-bold text-uppercase"> Online Hospital Management System - Developed by PATEL JAY |
						PATEL JESUS | PATEL KUSH</span>
				</div>
