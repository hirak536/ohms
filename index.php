...
<head>
    ...
    <link rel="stylesheet" type="assets/css" href="assets/scss/style.scss">
</head>
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12 "
                        style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">OHMS
                        <a data-toggle="collapse" data-target="#menu" href="#menu"><i
                                class="fas d-block d-md-none small-menu fa-bars"></i></a>
                    </div>
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item ">
                        <ul>
                            <li><a href="#" class="zoom">Home</a></li>
                            <li><a href="#services" class="zoom">Services</a></li>
                            <li><a href="#about_us" class="zoom">About Us</a></li>
                            <li><a href="#gallery" class="zoom">Gallery</a></li>
                            <li><a href="#contact_us" class="zoom">Contact Us</a></li>
                            <li><a href="#reach_us" class="zoom">How to reach</a></li>
                            <!--  <li><a href="#logins" class="zoom">Logins</a></li> -->
                        </ul>
                    </div>
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btc zoom shad rad" href="hms/user-login.php">Book an Appointment</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">WELCOME TO SAL HOSPITAL</h5>
        ...
        <div class="container">
            ...
            <div class="col-sm-12 blog-cont">
                <div class="row no-margin">
                    ...
                    <div class="col-sm-4 blog-smk" class="zoom " style="margin-left: 70px;">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btc click">Click Here</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 blog-smk" style="margin-left: 240px;">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                    <img src="assets/images/gallery/gallery_01.jpg" class="img-responsive zoom">
                </div>
    ...
    <section id="reach_us">
        ...
        <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=500&amp;height=400&amp;hl=en&amp;q=26-25, Purnima nagar, Ramrajya Nagar, Odhav, Ahmedabad, Gujarat 382415&amp;t=h&amp;z=18&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://strandsgame.net/">Strands Game</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:400px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:400px;}.gmap_iframe {height:400px!important;}</style></div>
        </section>
            ...
            <div class="col-sm-12 cop-ck">
                <form method="post">
                    ...
                    <div class="row cf-ro">
                        ...
                        <div class="col-sm-8">
                            <button class="btc click" type="submit" name="submit">Send Message</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        ...
                        <li><a ui-sref="products" href="#about_">About Us</a><i class="fa fa-angle-right"></i></li>
